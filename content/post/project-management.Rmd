...
## Documentation, visible to all the team members
...
* High level overview of major project areas, with facilitators/contacts and tentative timelines
...
* Progress made in recent meetings
* Activities that show progress towards project goals
* Any shifting goals, timeline or approach. This can include new tasks that have been identified or recent challenges that have slowed down one part of the project. It should be clear to all team members how their work is affected.
* Tentative plan until the next regular update
* Discussion points that should be covered in upcoming meetings
