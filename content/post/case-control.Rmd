...
To identify the effect of an exposure or treatment, we have to compare a group of people that were exposed to a group of people who were not, and see whether the risk or rate of a particular outcome is different between groups.

In a cohort study, we keep track of each group we're interested in. At the beginning of the study, we define the exposed and unexposed groups, and over the study period we see whether they go on to develop the outcome of interest. At the end of the study we can make a two-by-two table of results.
...
In case-control studies, we take the same approach of identifying who develops the outcome of interest, the cases. But unlike in a cohort study, we don't use the total numbers of exposed and unexposed in our calculation. Instead, we choose a method of sampling from the source population, and then we sort people into exposed and unexposed control groups.
